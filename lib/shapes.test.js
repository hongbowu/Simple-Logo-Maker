...
describe("shapes", () => {
  describe("circle", () => {
    it('should return `<circle cx="120" cy="100" r="80" fill=${shapesColor}></circle>`', () => {
      ...
      const circle = shapes.circle(`"blue"`);
      expect(circle).toBe(
  ...
  describe("square", () => {
    it('should return `<rect x="50" y="30" width="150" height="150" fill=${shapesColor}/></rect>`', () => {
      const shapes = new Shapes();
      const square = shapes.square(`"blue"`);
      expect(square).toBe(
  ...
  describe("rectangle", () => {
    it('should return `<rect x="50" y="50" width="150" height="100" fill=${shapesColor}/></rect>`', () => {
      const shapes = new Shapes();
      const rectangle = shapes.rectangle(`"blue"`);
...
describe("text",()=>{
    describe("textInput", () => {
        it('should return `<text x="125" y="125" font-size="60" text-anchor="middle" fill=${textColor}>${text}</text>`', () => {
          ...
          expect(input).toBe(
            `<text x="125" y="125" font-size="70" text-anchor="middle" fill="white">svg</text>`
          );
        });
      });
})